...
public class AppRequest1 extends HttpServlet {
	...
	try {
		...
		if ((method.equalsIgnoreCase("validateotp") || method.equalsIgnoreCase("isThereAnyStream") || method.equalsIgnoreCase("isStreamAlive")) && flag.equals(1)) {
		    if (isAliveFlag.equals(99)) {
			successJSON.put("url", (String) properties.getProperty("STREAM_URL"));
			successJSON.put("app_name", (String) properties.getProperty("WOWZA_APP_NAME"));
			successJSON.put("stream_name", (String) properties.getProperty("WOWZA_STREAM_NAME"));
			successJSON.put("smil_name", (String) properties.getProperty("SMIL_NAME"));
			String url = (String) properties.getProperty("WOWZA_URL");
			appName = (String) properties.getProperty("WOWZA_APP_NAME");
			streamName = (String) properties.getProperty("WOWZA_STREAM_NAME");
			List<String> list = streamBO.getStreamList(properties, url, appName, streamName);
			successJSON.put("stream", list);
		    }
		    // appName,live
		    // streamName,mystream
